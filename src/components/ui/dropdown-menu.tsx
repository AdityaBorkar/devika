...
>(({ className, inset, children, ...props }, ref) => (
	<DropdownMenuPrimitive.SubTrigger
		ref={ref}
		className={cn(
			'cursor-default flex items-center outline-none px-2 py-1.5 rounded-sm select-none text-sm focus:bg-accent data-[state=open]:bg-accent',
			inset && 'pl-8',
			className,
		)}
		{...props}
...
>(({ className, children, checked, ...props }, ref) => (
	<DropdownMenuPrimitive.CheckboxItem
		ref={ref}
		className={cn(
			'cursor-default data-[disabled]:opacity-50 data-[disabled]:pointer-events-none flex focus:bg-accent focus:text-accent-foreground outline-none pl-8 pr-2 py-1.5 relative rounded-sm select-none text-sm transition-colors',
			className,
		)}
		checked={checked}
		{...props}
...
>(({ className, children, ...props }, ref) => (
	...
	>
		<span className="absolute flex h-3.5 items-center justify-center left-2 w-3.5">
			<DropdownMenuPrimitive.ItemIndicator>
				<PiCircle className="fill-current h-2 w-2" />
			</DropdownMenuPrimitive.ItemIndicator>
		</span>
		{children}
	</DropdownMenuPrimitive.RadioItem>
...
>(({ className, ...props }, ref) => (
	<DropdownMenuPrimitive.Separator
		ref={ref}
		className={cn('bg-muted -mx-1 h-px my-1', className)}
		{...props}
	/>
));
...
const DropdownMenuShortcut = ({
	...
	return (
		<span
			className={cn('ml-auto opacity-60 text-xs tracking-widest', className)}
			{...props}
		/>
	);
};
